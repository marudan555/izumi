            ...
            <section class="area_information cont_inner">
                ...
                <ul class="list_information">
                    <li>
                        ...
                        <p>売る方から買う方へ。貸す方から借りる方へ。<br>
                            手渡されるのは、単なる物件や建物ではなく、<br>
                            資産性、住み心地、そして暮らしのよろこびという<br>
                            3つの価値を持つ「住まい」です。<br>
                            住まいの売買と賃貸において、<br>
                            お客様のご満足を追求する心と、<br>
                            成果をお届けするプロの技を尽くして、<br>
                            3つの価値を高めるお手伝いをする。<br>
                            それが「三菱地所の住まいリレー」です。
                        </p>
                        <a href="https://www.mec-h.com/" target="_blank" class="btn_detail">詳しくはこちら</a>
                    </li>
                    <li>
                        ...
                        <p>
                            <span class="big01">見えない想いも、かたちに。</span><br>
                            <span class="big02">リフォームのその先へ。</span><br>
                            私たちがもっとも大切にするのは、お客さまとの対話です。<br>
                            ご家族を想い、家を想う、お客さまの細やかな気持ちをも聞き出して皆様が気付いていない「願いや希望」を叶えていきたい。<br>
                            三菱地所グループの伝統と信頼。創業以来、長きに渡り培ってきた高品質なサービスと実績。<br>
                            確かな技術と創造性豊かな提案力。たどり着くのは、お客さまの想像を超えること。<br>
                            それが「三菱地所のリフォーム」の想いです。
                        </p>
